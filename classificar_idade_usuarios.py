...
def idade():
    with open('Dados/USUARIOS.csv', 'r') as arquivo_csv, open('Dados/USUARIOS_IDADE.csv', mode='w', newline='') as novocsvfile:
        ...
        for linha in leitor_csv:
            ...
            # Executa o arquivo python
            subprocess.run(["python3", "gerar_csv_cliente_idade.py", str(valor_coluna)], capture_output=False, text=False)
            ...
            output = subprocess.check_output(["python3", "teste-naive-bayes-pets_idade.py", str(valor_coluna) , str(5)])
