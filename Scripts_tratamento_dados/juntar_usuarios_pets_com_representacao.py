...
FILE_1_PATH = '../Dados/USUARIOS_PETS_FINAL.csv'
FILE_2_PATH = '../Dados/USUARIOS_REPRESENTACAO.csv'
...
df_merged.to_csv('../Dados/USUARIOS_PETS_REPRESENTACAO_FINAL.csv', index=False)
